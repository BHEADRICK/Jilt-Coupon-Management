<?php
/**
 * Jilt_Coupon_Management Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_jilt_coupon_management_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/jilt-coupon-management.php';
}
